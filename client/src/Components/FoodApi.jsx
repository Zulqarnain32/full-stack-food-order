export const FoodApi = [
    ...
    },
    {
      ...
      price: 130,
      desc: "A classic Italian pizza topped  fresh tomatoes,  basil leaves, and a drizzle of olive oil. Simple yet bursting with flavors, this Margherita Pizza is a timeless favorite that captures the essence of Italian cuisine.",
      category: "Lunch",
      rating: 4.2,
    },
    {
    ...
    },
    {
      ...
      name: "Mushroom  Pizza",
      price: 140,
      desc: "Experience the earthy flavors  with the freshness of spinach on this delightful pizza. Topped with a blend of cheeses, this Mushroom and Spinach Pizza offers a balanced and satisfying taste.",
      category: "Lunch",
      rating: 4.2,
    },
    {
      ...
      price: 170,
      desc: "Savor the smoky  of this BBQ Chicken Pizza, featuring tender pieces of chicken marinated in barbecue sauce, red onions, and a medley of cheeses. A fusion of flavors that's sure to delight your taste buds.",
      category: "Lunch",
      rating: 4.8,
    },
    {
    ...
    },
    {
      ...
      price: 110,
      desc: "Indulge in a buttery  filled with scrambled eggs, crispy bacon, and melted cheese. A savory and satisfying breakfast option that's perfect for on-the-go mornings.",
      category: "Breakfast",
      rating: 4.2,
    },
    {
      ...
      price: 95,
      desc: "Enjoy a healthy and   with layers of creamy Greek yogurt, fresh berries, honey, and granola. A balanced option that provides a burst of flavors and energy.",
      category: "Breakfast",
      rating: 4.1,
    },
    {
    ...
    },
    {
      ...
      price: 85,
      desc: "Warm up with a bowl of hearty  packed with mixed fruits, nuts, and a drizzle of honey. A wholesome breakfast that provides a satisfying start to your day.",
      category: "Breakfast",
      rating: 4.5,
    },
    {
    ...
    },
    {
      ...
      price: 175,
      desc: "Indulge in creamy and flavorful  risotto, made with Arborio rice, sautéed mushrooms, and a touch of Parmesan cheese. A comforting and sophisticated dinner choice.",
      category: "Dinner",
      rating: 4.5,
    },
    {
    ...
    },
    {
      ...
      name: "Veggie Platter",
      price: 90,
      desc: "Relish the smooth and flavorful  accompanied  variety of fresh vegetable sticks and . A nutritious and satisfying option for a light and refreshing snack.",
      category: "Snacks",
      rating: 4.4,
    },
    {
      ...
      name: "Fruit Skewers",
      price: 70,
      desc: "Indulge in a colorful  of fruit skewers featuring juicy chunks of melon, berries, pineapple, and more. A sweet and refreshing snack that's both delicious and visually appealing.",
      category: "Snacks",
      rating: 4.8,
    },
  ];
